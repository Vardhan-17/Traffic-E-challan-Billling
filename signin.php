...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $userdesg= $_POST["userdesg"];
    $cpassword= $_POST["cpassword"];
    // $exists=false;
    if(($password == $cpassword)){
        $hash = password_hash($password, PASSWORD_DEFAULT);
        $sql = "INSERT INTO `staff` (`staffid`, `staffname`, `staffdesg`, `staffpsw`) VALUES ('$userid', '$username', '$userdesg', '$hash');";
...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
     ...
     <h2 class="text-center mt-4">Staff Signup</h2>
     <hr style="border-top: 1px dashed #8c8b8b;">
     <form action="/tms/signin.php" method="post">
        ...
        <div class="row mt-3 justify-content-md-center">
            <div class="col col-lg-5">
            <label for="userdesg">Userdesgination</label>
            <input type="text" class="form-control" placeholder="" pattern="[A-Za-z]{0,20}" id="userdesg" name="userdesg" required autocomplete="off">
            <small class="form-text text-muted">Only characters</small>
            </div>
        </div>
        <div class="row mt-3 justify-content-md-center">
            ...
            <input type="password" class="form-control" placeholder="" id="password" pattern="[0-9]{3,9}" name="password" required>
        ...
        <div class="row mt-3 justify-content-md-center">
            ...
            <input type="password" class="form-control" placeholder="" id="cpassword" pattern="[0-9]{3,9}" name="cpassword" required >
        ...
        <div class="row mt-3 justify-content-md-center">
            ...
            <a href="/tms/signinuser.php" class="text-dark">Not staff?Signup here</a>
            </div>
        </div>
     </form>
