...
<body>
  ...
  <div class="container">
    ...
    <div class="text-center">
      ...
      <h2 class="text mt-4">Billing History</h2>
    </div>
    ...
    <form method="post" action="/tms/search.php">
      <div class="row mx-1">
        ...
        <input class="form-control col-2 mx-2" type="search" placeholder="Search" aria-label="Search" name="search"
          required>
    ...
    <?php
      ...
      echo '<div class="my-5"><h1 class=text-center>No History</h1></div>';
    }
    ?>
